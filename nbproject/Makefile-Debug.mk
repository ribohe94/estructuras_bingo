...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/estructuras_bingo

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/estructuras_bingo: ${OBJECTFILES}
...
${OBJECTDIR}/ContenedorJugadores.o: ContenedorJugadores.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ContenedorJugadores.o ContenedorJugadores.cpp

${OBJECTDIR}/GestorJuego.o: GestorJuego.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GestorJuego.o GestorJuego.cpp
...
${OBJECTDIR}/NodoJugador.o: NodoJugador.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NodoJugador.o NodoJugador.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/estructuras_bingo
